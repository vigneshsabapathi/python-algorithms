...
An AVL tree maintains the invariant that for every node, the heights of the
left and right subtrees differ by at most 1 (balance factor ∈ {-1, 0, 1}).

For doctests run:
    python -m doctest binary_tree_avl_tree.py -v
"""
