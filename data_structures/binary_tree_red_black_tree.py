...
def main() -> None:
    ...
    >>> pytests()
    """
    print("Rotating right and left", "works!" if test_rotations() else "doesn't work")
    print("Inserting", "works!" if test_insert() else "doesn't work")
    print("Searching", "works!" if test_insert_and_search() else "doesn't work")
    print("Deleting", "works!" if test_insert_delete() else "doesn't work")
    print("Floor and ceil", "works!" if test_floor_ceil() else "doesn't work")
    print("Tree traversal", "works!" if test_tree_traversal() else "doesn't work")
    print("Tree chaining", "works!" if test_tree_chaining() else "doesn't work")
