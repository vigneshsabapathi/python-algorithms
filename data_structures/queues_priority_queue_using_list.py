...
class FixedPriorityQueue:
    ...
    are removed then the Task with the highest priority is removed in FIFO order.
    Priority zero Tasks are the most urgent (high priority); priority 2 tasks the least.
    ...
    Traceback (most recent call last):
        ...
    queues_priority_queue_using_list.UnderFlowError: All queues are empty
    >>> print(fpq)
    Priority 0: []
    Priority 1: []
    Priority 2: []
...
class ElementPriorityQueue:
    """
    Element Priority Queue: the value of the element itself is the priority.
    ...
    Traceback (most recent call last):
        ...
    queues_priority_queue_using_list.UnderFlowError: The queue is empty
    >>> print(epq)
    []
    """
