...
if __name__ == "__main__":
    ...
    testmod()
    sym = make_symmetric_tree()
    asym = make_asymmetric_tree()
    print(f"Symmetric tree is symmetric: {is_symmetric_tree(sym)}")
    print(f"Asymmetric tree is symmetric: {is_symmetric_tree(asym)}")
