...
It uses a flat array with bit-manipulation to navigate parent/child nodes.

Reference: https://en.wikipedia.org/wiki/Fenwick_tree

For doctests run:
    python -m doctest binary_tree_fenwick_tree.py -v
"""
...
if __name__ == "__main__":
    ...
    doctest.testmod()
    f = FenwickTree([1, 2, 3, 4, 5])
    print("Prefix sum [0,3):", f.prefix(3))
    print("Range query [1,4):", f.query(1, 4))
