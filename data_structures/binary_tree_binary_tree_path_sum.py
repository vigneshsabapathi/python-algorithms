...
Count paths in a binary tree that sum to a given target.
Paths do not need to start at the root or end at a leaf — any downward path counts.

For doctests run:
    python -m doctest binary_tree_binary_tree_path_sum.py -v
"""
