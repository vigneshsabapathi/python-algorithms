...
A Sum Tree is a binary tree where every non-leaf node's value equals the sum
of all values in its left and right subtrees. Leaf nodes are trivially sum nodes.

For doctests run:
    python -m doctest binary_tree_is_sum_tree.py -v
"""
