...
Reference: https://en.wikipedia.org/wiki/Electrical_reactance#Inductive_reactance

Run:
    python -m doctest electronics/ind_reactance.py -v
"""
...
def ind_reactance(
    ...
    """
    Calculate inductive reactance, frequency, or inductance (set unknown to 0).
