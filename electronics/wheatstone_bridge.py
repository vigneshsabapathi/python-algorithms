#!/usr/bin/env python3
"""
Wheatstone Bridge — find unknown resistance: Rx = (R2/R1) * R3.

Reference: https://en.wikipedia.org/wiki/Wheatstone_bridge

Run:
    python -m doctest electronics/wheatstone_bridge.py -v
"""
