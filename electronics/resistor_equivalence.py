#!/usr/bin/env python3
"""
Resistor Equivalence — series and parallel equivalent resistance.

Reference: https://byjus.com/equivalent-resistance-formula/

Run:
    python -m doctest electronics/resistor_equivalence.py -v
"""
