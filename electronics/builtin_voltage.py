#!/usr/bin/env python3
"""
Builtin Voltage — calculate the built-in voltage of a pn junction diode.

Uses the thermal voltage equation: V_bi = (kT/q) * ln(Na*Nd / ni^2)
Reference: https://en.wikipedia.org/wiki/P%E2%80%93n_junction

Run:
    python -m doctest electronics/builtin_voltage.py -v
"""
...
def builtin_voltage(
    ...
    """
    Calculate the Builtin Voltage of a pn junction diode.
