#!/usr/bin/env python3
"""
Real and Reactive Power — from apparent power and power factor.

P_real = S * pf
P_reactive = S * sqrt(1 - pf^2)
Reference: https://en.wikipedia.org/wiki/AC_power

Run:
    python -m doctest electronics/real_and_reactive_power.py -v
"""
