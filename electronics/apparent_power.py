#!/usr/bin/env python3
"""
Apparent Power — calculate apparent power in a single-phase AC circuit.

Apparent power S = V * I* (conjugate), computed via phasor multiplication.
Reference: https://en.wikipedia.org/wiki/AC_power#Apparent_power

Run:
    python -m doctest electronics/apparent_power.py -v
"""
