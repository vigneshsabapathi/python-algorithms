"""
Convert currency using the Amdoren Currency API.

API: https://www.amdoren.com/currency-api/
Set AMDOREN_API_KEY environment variable before use.
"""
...
CURRENCIES = {
    ...
    "MOP": "Macau Pataca", "MRO": "Mauritanian Ouguiya",
    ...
    "PYG": "Paraguayan Guarani", "QAR": "Qatari Riyal",
...
def convert_currency(
    ...
    """
    Convert an amount from one currency to another via the Amdoren API.

    >>> convert_currency("USD", "INR", 1.0, "")  # doctest: +SKIP
    '83.5'
    """
    params = {"from": from_, "to": to, "amount": amount, "api_key": api_key}
...
if __name__ == "__main__":
    ...
    if not API_KEY:
        raise KeyError("Set AMDOREN_API_KEY environment variable first.")
    print(
        convert_currency(
