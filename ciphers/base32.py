...
Converts bytes to a Base32 (RFC 4648) string using the charset A-Z and 2-7.
Padding with '=' aligns output to multiples of 8 characters.
...
def base32_decode(data: bytes) -> bytes:
    """
    Decode Base32 bytes back to the original bytes.
